...
| `face_cycle_invasion_P1.py`, `face_cycle_invasion_P2.py` | invasion rates on the face cycles, Section 8.1 |
...
| `mc_run.py`, `mc_edges.py` | Monte Carlo robustness, Section 8.1 | 2024 |
| `prcc_large.py`, `prcc_check.py` | partial rank correlations, Table 4 | 7 |
| `cond_robust.py` | conditioning of the sensitivity analysis | -- |
| `robust_extra_variants.py`, `table6_osc.py` | alternative functional forms, Table 5 | -- |
...
| `mechanism_factorial.py` | factorial trait design and three grazing responses, Table 6 | -- |
...
| `identifiability_uncertainty.py` | profile and bootstrap intervals, Table 7 | 20260718 |
| `null_models.py`, `aic_bic_modelselection.py` | null-model comparison, Table 8 | -- |
...
distributions summarized in Section 8.1.
